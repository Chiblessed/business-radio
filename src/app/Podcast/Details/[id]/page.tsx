...
<div
  ...
  {/* Content */}
  <div className='relative z-10 w-full px-10 max-sm:px-3 sm:px-3 md:px-3'>
    <Link href='/Podcast'>
...
<path d="M6 9L1 5L6 1" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
      ...
      Back to podcast</h2>
          ...
          <div className=' flex items-start justify-center  gap-4 mr-44 max-sm:mr-0 max-sm:flex-col sm:mr-0 sm:flex'>
            <Image src={episode.picture_url} width={150} height={150} alt='' className='max-sm:w-[20rem] sm:w-[20rem]'/>
...
<h2 className='uppercase border-b-2 border-b-green-950 mt-10 text-left mx-10 text-[#5A5A5A] font-semibold text-sm py-3'>
    Next Episode in Queue
</h2>
<div className='flex items-start justify-start gap-4 mt-5 mx-10 max-sm:flex-col  max-sm:px-3   sm:px-3'>
