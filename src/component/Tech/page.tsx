...
function Tech() {
    ...
    for (let i = 0; i < getData.length; i++) {
      ...
      if (item.category_type === "TECHNOLOGY" ||
         item.category_type === "BUSINESS") {
        result.push(item);
      }
            ...
            {displayData?.map((item, index) => {
                return(
                    <div
                     ...
                     className='bg-[#F4F4F4] flex flex-col max-sm:items-center max-sm:w-full sm:items-center sm:w-full items-start justify-start shadow-lg rounded-xl py-5 px-4'>
