...
import Banner1 from '@/../../public/assets/Rectangle 56.png';
import Banner2 from '@/../../public/assets/Rectangle 54.png';
...
>>>>>>> 99b5df0e909c38ff651d8a6e7f325e3c290fcb38
        ...
        <div className=' w-full flex flex-col items-start justify-start gap-2 shadow-dark-900 ' >
        <div className='text-[13px] font-bold flex items-center justify-center text-[#828282] gap-4 py-2 mt-2'>
            <p className='text-[13px] font-bold '>AUG 29, 2023</p>
            <div className='w-2 h-2 bg-[#828282] rounded-full' />
            <p>45 MINS</p>
            </div>
                <h2
                className='font-extrabold text-base text-[#282828]'
                >
                    Relationship Button - Starting Afresh as a Widow
                </h2>
        </div>
        <div className=' flex items-center max-sm:flex max-sm:items-center max-sm:justify-start justify-center  text-[#828282] gap-4 mt-6'>
            <p className='text-[13px] font-bold '>More Epsiodes</p>
            <div className='px-2 py-2 rounded-full bg-[#828282]' >
...
<rect width="18" height="18" fill="white"/>
        ...
        <div className=''>
                    <Image src={Banner2} width={600} height={200} alt='' />
        <div className=' w-full flex flex-col items-start justify-start gap-2 shadow-dark-900 ' >
        <div className='text-[13px] pt-2 font-bold flex items-center justify-center text-[#828282] gap-4 py-2 mt-2'>
            <p>AUG 29, 2023</p>
            <div className='w-2 h-2 bg-[#828282] rounded-full' />
            <p>45 MINS</p>
            </div>
                ...
                className='font-extrabold text-base text-[#282828]'
                >
                    Employee Well-being: Prioritising Mental Health in the Workplace
                </h2>
        </div>
        <div className=' flex items-center justify-start text-[#828282] gap-4 mt-3'>
            <p className='text-[13px] font-bold'>More Epsiodes</p>
            <div className='px-2 rounded-full py-2 bg-[#828282]' >
            <svg width="17" height="18" viewBox="0 0 17 18" fill="none" xmlns="http://www.w3.org/2000/svg">
<g clipPath="url(#clip0_1_464)">
<path d="M0.000269969 8.99032C-0.0067468 10.7533 1.41679 12.1882 3.17983 12.1952C3.99178 12.1985 4.77447 11.8922 5.36855 11.3387L10.1257 13.4866C10.0926 13.6644 10.0745 13.8447 10.0715 14.0256C10.0659 15.8008 11.5003 17.2444 13.2755 17.25C15.0507 17.2556 16.4943 15.8211 16.4999 14.0459C16.5056 12.2708 15.071 10.8272 13.2959 10.8215C12.2353 10.8182 11.2413 11.3382 10.6393 12.2114L6.16988 10.1933C6.48734 9.42678 6.48856 8.56574 6.17332 7.79828L10.6366 5.76988C11.6416 7.22348 13.6348 7.58707 15.0884 6.58203C16.542 5.57699 16.9055 3.5839 15.9005 2.1303C14.8954 0.676706 12.9023 0.313121 11.4487 1.31816C10.583 1.91671 10.0671 2.90263 10.0687 3.95508C10.0716 4.13623 10.09 4.31677 10.1236 4.49479L5.37885 6.65087C4.09333 5.44376 2.07266 5.50733 0.865554 6.79285C0.306884 7.38786 -0.00275561 8.17416 0.000269969 8.99032Z" fill="#5A5A5A"/>
</g>
...
<rect width="18" height="18" fill="white"/>
        ...
        <div className=''>
                    <Image src={Banner1} width={600} height={200} alt='' />
        <div className='w-full flex flex-col items-start justify-start gap-2 shadow-dark-900' >
        <div className='text-[13px] font-bold flex items-center justify-center text-[#828282] gap-4 py-2 mt-4'>
            <p>AUG 29, 2023</p>
            <div className='w-2 rounded-full h-2 bg-[#828282]' />
            <p>45 MINS</p>
            </div>
                <h2
                className='font-extrabold text-base text-[#282828]'
        ...
        <div className='text-[13px] font-bold flex items-center justify-center max-sm:flex max-sm:items-center max-sm:justify-start text-[#828282] gap-4 mt-6'>
            <p>More Epsiodes</p>
            <div className='px-2 py-2 rounded-full bg-[#828282]' >
            <svg width="17" height="18" viewBox="0 0 17 18" fill="none" xmlns="http://www.w3.org/2000/svg">
<g clipPath="url(#clip0_1_464)">
...
<rect width="18" height="18" fill="white"/>
        ...
        <div className='text-[13px] font-bold flex items-start justify-center max-sm:flex max-sm:items-center max-sm:justify-start text-[#828282] gap-4 mt-6'>
            <p>More Epsiodes</p>
            <div className='px-2 py-2 rounded-full bg-[#828282]' >
            <svg width="17" height="18" viewBox="0 0 17 18" fill="none" xmlns="http://www.w3.org/2000/svg">
<g clipPath="url(#clip0_1_464)">
...
<rect width="18" height="18" fill="white"/>
        ...
        <div className=''>
                    <Image src={Banner1} width={600} height={200} alt='' />
        <div className=' w-full flex flex-col items-start justify-start gap-2 shadow-dark-900' >
        <div className='text-[13px] font-bold flex items-start justify-center text-[#828282] gap-4 py-2 mt-4'>
            <p>AUG 29, 2023</p>
            <div className='w-2 h-2 rounded-full bg-[#828282]' />
            <p>45 MINS</p>
            </div>
        ...
        <div className='text-[13px] font-bold flex items-center mt-6 justify-center max-sm:flex max-sm:items-center max-sm:justify-start text-[#828282] gap-4 '>
            <p>More Epsiodes</p>
            <div className='px-2 py-2 rounded-full bg-[#828282]' >
            <svg width="17" height="18" viewBox="0 0 17 18" fill="none" xmlns="http://www.w3.org/2000/svg">
<g clipPath="url(#clip0_1_464)">
